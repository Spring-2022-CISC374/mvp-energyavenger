class instructionScreen extends Phaser.Scene {
    ...
    create(){
        ...
        this.add.text(this.game.config.width / 6.2, this.game.config.height * 0.45, "Your job is to protect the environment and save energy! \nUse the WASD keys or the arrow keys to move and use the space \nbar to defeat the evil carbon monsters! Destroy all of the  \nenemies, then turn off the power switch!", {fontSize: '24px', align: 'center'});
